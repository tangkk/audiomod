...
protected:
    ...
    // void baseProcess(const float *const *inputBuffers, Vamp::RealTime timestamp); // not implemented yet
    void baseProcess(const float *realOut, const float *imagOut, Vamp::RealTime timestamp);
