...
public:
    struct Config {
        ...
        Config(float _sampleRate, float _tuningFrequency) :
...
protected:
    float krumCorr(const float *pDataNorm, const float *pProfileNorm, 
    ...
    float* m_majProfileNorm;
    float* m_minProfileNorm;
    float* m_majCorr;
    float* m_minCorr;
